...
import Logo from '@/public/Screenshot 2025-01-19 192258.png'; // Default logo
  ...
  return (
    <div key={challenge.id} className="bg-white rounded-[12px] border-[0.98px] border-[#E4E7EC] h-full w-full px-[16px] pt-[16px]">
      <div className="bg-[#2B71F0] relative rounded-lg h-[199px] flex items-center justify-center">
        <span className="bg-[#0F973D] absolute top-[13px] right-[13px] text-center w-[81px] h-[28px] z-10 font-sans font-normal text-[14px] text-white rounded-[12px] flex items-center justify-center">
